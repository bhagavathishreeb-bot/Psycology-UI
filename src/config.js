...
export const CONFIG = {
  ...
  // Social media links
  socialLinks: {
    youtube: 'https://youtube.com/@bhagavathishreebv',
    instagram: 'https://www.instagram.com/bhagavathi__shree/',
    linkedin: 'https://www.linkedin.com/in/bhagavathishreebv/',
  },
  ...
  youtubeVideos: [
    { id: 'zGAB-6oRItY', title: 'Mental Wellness Tips' },
    { id: 'rWzIqOlUNHM', title: 'Psychology Insights' },
    { id: 'NpoIxtqogBI', title: 'Self-Care & Growth' },
  ],
  ...
  // Ratings - update with real numbers
  ratings: {
    score: '4.9/5',
    count: '308 ratings',
    testimonials: '245',
  ...
  reviews: [
    ...
    { name: 'Kavya L.', rating: 5, text: 'I was skeptical at first, but Bhagavathi Shree changed my perspective. Her approach is unique and effective.', date: '2 months ago' },
